export default function AboutSection() {
  return (
    <section id="about" className="relative z-10 py-20 px-8 md:px-16 bg-black/20">
      <div className="max-w-6xl mx-auto">
        ...
        <p>
        Beyond coding, I enjoy keeping up with emerging trends in technology, exploring open-source projects, and connecting with like-minded individuals to share knowledge and inspiration. Let’s build something amazing together!
        </p>
        </div>
      </div>
    </section>
